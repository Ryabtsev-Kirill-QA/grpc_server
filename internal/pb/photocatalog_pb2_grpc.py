...
if _version_not_supported:
    raise RuntimeError(
        ...
        + ' but the generated code in photocatalog_pb2_grpc.py depends on'
...
class PhotoCatalogServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.UploadPhotos = channel.stream_unary(
                ...
                request_serializer=photocatalog__pb2.PhotoRequest.SerializeToString,
                response_deserializer=photocatalog__pb2.UploadPhotosStatus.FromString,
                _registered_method=True)
...
def add_PhotoCatalogServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'UploadPhotos': grpc.stream_unary_rpc_method_handler(
                    ...
                    request_deserializer=photocatalog__pb2.PhotoRequest.FromString,
                    response_serializer=photocatalog__pb2.UploadPhotosStatus.SerializeToString,
            ),
    }
...
class PhotoCatalogService(object):
    ...
    def UploadPhotos(request_iterator,
        ...
        return grpc.experimental.stream_unary(
            ...
            '/PhotoCatalogService/UploadPhotos',
            photocatalog__pb2.PhotoRequest.SerializeToString,
            photocatalog__pb2.UploadPhotosStatus.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
